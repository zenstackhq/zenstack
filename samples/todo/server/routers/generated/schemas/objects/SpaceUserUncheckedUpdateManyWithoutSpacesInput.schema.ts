...
const Schema: z.ZodType<Prisma.SpaceUserUncheckedUpdateManyWithoutSpacesInput> = z
    .object({
...
export const SpaceUserUncheckedUpdateManyWithoutSpacesInputObjectSchema = Schema;
