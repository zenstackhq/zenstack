...
exports.Prisma.SpaceUserScalarFieldEnum = makeEnum({
  id: 'id',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt',
  spaceId: 'spaceId',
...
exports.SpaceUserRole = makeEnum({
  USER: 'USER',
  ADMIN: 'ADMIN'
});
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/yiming/git/zenstack/zenstack/samples/todo/.zenstack/.prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), ".zenstack/.prisma/libquery_engine-darwin-arm64.dylib.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), ".zenstack/.prisma/schema.prisma")
