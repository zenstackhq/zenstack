...
const Schema: z.ZodType<Prisma.TodoUncheckedUpdateManyWithoutListNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          ...
          z
            .lazy(() => TodoUpsertWithWhereUniqueWithoutListInputObjectSchema)
            .array(),
        ])
        .optional(),
      createMany: z
        .lazy(() => TodoCreateManyListInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          ...
          z
            .lazy(() => TodoUpdateWithWhereUniqueWithoutListInputObjectSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          ...
          z
            .lazy(() => TodoUpdateManyWithWhereWithoutListInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
