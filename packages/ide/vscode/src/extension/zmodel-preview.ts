...
import { API_URL, AUTH_PROVIDER_ID } from './zenstack-auth-provider';
...
export class ZModelPreview implements vscode.Disposable {
    ...
    private registerCommands(context: vscode.ExtensionContext): void {
        ...
        context.subscriptions.push(
            vscode.commands.registerCommand('zenstack.preview-zmodel-v3', async () => {
        ...
        context.subscriptions.push(
            vscode.commands.registerCommand('zenstack.save-zmodel-documentation-v3', async () => {
        ...
        context.subscriptions.push(
            vscode.commands.registerCommand('zenstack.clear-documentation-cache-v3', async () => {
    ...
    private async requireAuth(): Promise<vscode.AuthenticationSession | undefined> {
