...
const Schema: z.ZodType<Prisma.SpaceUserUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => SpaceUserUpdateManyWithWhereWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => SpaceUserUpdateManyWithWhereWithoutUserInputObjectSchema,
...
export const SpaceUserUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
