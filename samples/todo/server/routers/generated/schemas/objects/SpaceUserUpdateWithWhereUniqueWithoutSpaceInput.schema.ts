...
const Schema: z.ZodType<Prisma.SpaceUserUpdateWithWhereUniqueWithoutSpaceInput> = z
    .object({
...
export const SpaceUserUpdateWithWhereUniqueWithoutSpaceInputObjectSchema = Schema;
