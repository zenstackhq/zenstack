...
export type RequestHandlerOptions = {
    /**
     * Hook method for getting a Prisma instance for the given request/response pair.
     */
    getPrisma: (
        req: NextApiRequest,
        res: NextApiResponse
...
async function handleRequest(
    ...
    const [model, method] = req.query.path as string[];

    const dbOp = method as DbOperationName;
    ...
    switch (dbOp) {
        ...
        default:
            res.status(400).send({ error: `unknown method name: ${method}` });
            break;
    }
