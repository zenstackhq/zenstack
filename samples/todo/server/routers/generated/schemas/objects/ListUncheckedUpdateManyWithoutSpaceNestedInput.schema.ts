...
const Schema: z.ZodType<Prisma.ListUncheckedUpdateManyWithoutSpaceNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => ListUncheckedCreateWithoutSpaceInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => ListCreateOrConnectWithoutSpaceInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          ...
          z
            .lazy(() => ListUpsertWithWhereUniqueWithoutSpaceInputObjectSchema)
            .array(),
        ])
        .optional(),
      createMany: z
        .lazy(() => ListCreateManySpaceInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          ...
          z
            .lazy(() => ListUpdateWithWhereUniqueWithoutSpaceInputObjectSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          ...
          z
            .lazy(() => ListUpdateManyWithWhereWithoutSpaceInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export const ListUncheckedUpdateManyWithoutSpaceNestedInputObjectSchema =
  Schema;
