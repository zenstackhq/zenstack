...
const Schema: z.ZodType<Prisma.SpaceUserUncheckedUpdateManyWithoutUserNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => SpaceUserUpsertWithWhereUniqueWithoutUserInputObjectSchema),
                z.lazy(() => SpaceUserUpsertWithWhereUniqueWithoutUserInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => SpaceUserUpdateWithWhereUniqueWithoutUserInputObjectSchema),
                z.lazy(() => SpaceUserUpdateWithWhereUniqueWithoutUserInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => SpaceUserUpdateManyWithWhereWithoutUserInputObjectSchema),
                z.lazy(() => SpaceUserUpdateManyWithWhereWithoutUserInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
...
export const SpaceUserUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
