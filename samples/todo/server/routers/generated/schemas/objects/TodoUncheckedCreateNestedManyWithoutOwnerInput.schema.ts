...
const Schema: z.ZodType<Prisma.TodoUncheckedCreateNestedManyWithoutOwnerInput> = z
    .object({
        create: z
            .union([
...
export const TodoUncheckedCreateNestedManyWithoutOwnerInputObjectSchema = Schema;
