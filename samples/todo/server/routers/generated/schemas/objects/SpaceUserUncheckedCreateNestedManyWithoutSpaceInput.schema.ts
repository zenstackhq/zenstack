...
const Schema: z.ZodType<Prisma.SpaceUserUncheckedCreateNestedManyWithoutSpaceInput> = z
    .object({
        create: z
            .union([
...
export const SpaceUserUncheckedCreateNestedManyWithoutSpaceInputObjectSchema = Schema;
