...
const Schema: z.ZodType<Prisma.TodoUncheckedUpdateManyWithoutOwnerNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                ...
                z.lazy(() => TodoUpsertWithWhereUniqueWithoutOwnerInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                ...
                z.lazy(() => TodoUpdateWithWhereUniqueWithoutOwnerInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => TodoUpdateManyWithWhereWithoutOwnerInputObjectSchema),
                z.lazy(() => TodoUpdateManyWithWhereWithoutOwnerInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
...
export const TodoUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema = Schema;
