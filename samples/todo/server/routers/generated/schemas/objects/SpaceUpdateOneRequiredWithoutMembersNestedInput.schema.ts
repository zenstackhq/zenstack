...
const Schema: z.ZodType<Prisma.SpaceUpdateOneRequiredWithoutMembersNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z.lazy(() => SpaceUpsertWithoutMembersInputObjectSchema).optional(),
...
export const SpaceUpdateOneRequiredWithoutMembersNestedInputObjectSchema = Schema;
