...
/**
 * Creates an Angular TanStack Query v5 query.
 *
...
/**
 * Creates an Angular TanStack Query v5 infinite query.
 *
 * @param model The name of the model under query.
 * @param url The request URL.
...
export function useInfiniteModelQuery<TQueryFnData, TData, TError>(
    ...
    const query = injectInfiniteQuery<TQueryFnData, TError, InfiniteData<TData>>(() => ({
        queryKey,
...
/**
 * Creates an Angular TanStack Query v5 mutation.
 *
