...
const Schema: z.ZodType<Prisma.ListUncheckedUpdateManyWithoutSpaceNestedInput> = z
    .object({
        create: z
            .union([
...
export const ListUncheckedUpdateManyWithoutSpaceNestedInputObjectSchema = Schema;
