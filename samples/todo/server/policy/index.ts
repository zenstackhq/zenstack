...
function Space_create(context: QueryContext): any {
    const user = context.user?.id
        ? context.user
        : { ...context.user, id: 'zenstack_unknown_user' };
    const r = {
        AND: [
            {
                NOT: {
...
const policy = {
    fieldMapping: {
        space: {
            ...
            name: {
                ...
                isOptional: false,
                attributes: [
                    { name: '@length', args: [{ value: 4 }, { value: 50 }] },
                ],
            },
            slug: {
                name: 'slug',
        ...
        list: {
            ...
            title: {
                ...
                isOptional: false,
                attributes: [
                    { name: '@length', args: [{ value: 1 }, { value: 100 }] },
                ],
            },
            private: {
                name: 'private',
    ...
    guard: {
        ...
        spaceUser: {
            create: SpaceUser_create,
            update: SpaceUser_update,
            read: SpaceUser_read,
            delete: SpaceUser_delete,
        },
        user: {
            create: User_create,
            update: User_update,
