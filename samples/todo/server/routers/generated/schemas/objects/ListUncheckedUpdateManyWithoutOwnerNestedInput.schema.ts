...
const Schema: z.ZodType<Prisma.ListUncheckedUpdateManyWithoutOwnerNestedInput> = z
    .object({
        create: z
            .union([
...
export const ListUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema = Schema;
