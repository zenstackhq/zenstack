...
const Schema: z.ZodType<Prisma.ListUncheckedUpdateManyWithoutOwnerNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => ListUncheckedCreateWithoutOwnerInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => ListCreateOrConnectWithoutOwnerInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          ...
          z
            .lazy(() => ListUpsertWithWhereUniqueWithoutOwnerInputObjectSchema)
            .array(),
        ])
        .optional(),
      createMany: z
        .lazy(() => ListCreateManyOwnerInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          ...
          z
            .lazy(() => ListUpdateWithWhereUniqueWithoutOwnerInputObjectSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          ...
          z
            .lazy(() => ListUpdateManyWithWhereWithoutOwnerInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export const ListUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema =
  Schema;
