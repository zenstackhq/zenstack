...
const Schema: z.ZodType<Prisma.SpaceUserUncheckedUpdateManyWithoutSpaceNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => SpaceUserUpsertWithWhereUniqueWithoutSpaceInputObjectSchema,
          ),
          z
            .lazy(
              () => SpaceUserUpsertWithWhereUniqueWithoutSpaceInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => SpaceUserUpdateWithWhereUniqueWithoutSpaceInputObjectSchema,
          ),
          z
            .lazy(
              () => SpaceUserUpdateWithWhereUniqueWithoutSpaceInputObjectSchema,
      ...
      updateMany: z
        .union([
          z.lazy(
            () => SpaceUserUpdateManyWithWhereWithoutSpaceInputObjectSchema,
          ),
          z
            .lazy(
              () => SpaceUserUpdateManyWithWhereWithoutSpaceInputObjectSchema,
...
export const SpaceUserUncheckedUpdateManyWithoutSpaceNestedInputObjectSchema =
  Schema;
